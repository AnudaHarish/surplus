...
<html lang="en">
	<head>
		...
		<!--link to the logo min-->
		<link rel="shortcut icon" href="main/images/surplus_logo_min.png">
		...
		<div class="container-fluid">
			...
			<div id="login">
				...
				<form action="login.php" method="post">
					...
					<center><img src="main/images/surplus_logo.png" width="150px"></center>
					<br>
					
		
					<div class="input-group">

						<span style="height:40px; width:25px;" class="add-on">
